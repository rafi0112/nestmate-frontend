    ...
    <div style={{ minHeight: '100vh', display: 'flex', background: 'var(--bg)' }}>
      ...
      <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '40px 24px' }}>
        <div style={{ width: '100%', maxWidth: 440 }}>
          ...
          {/* Google */}
          <button onClick={handleGoogle} style={{ width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 12, padding: '13px', borderRadius: 10, border: '1.5px solid var(--border)', background: 'var(--bg-card)', fontSize: 14, fontWeight: 600, fontFamily: 'Times New Roman', color: 'var(--text-primary)', cursor: 'pointer', marginBottom: 24, transition: 'all 0.15s' }}
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            <button type="submit" disabled={loading}
              style={{ padding: '13px', borderRadius: 10, background: loading ? 'var(--border-strong)' : 'var(--accent)', color: loading ? 'var(--text-muted)' : '#fff', fontSize: 15, fontWeight: 700, fontFamily: 'Times New Roman', border: 'none', cursor: loading ? 'not-allowed' : 'pointer', transition: 'all 0.15s' }}>
